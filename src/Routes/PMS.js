    ...
    return(
        <Wrapper>
            ...
            <PmsWrapper>
                ...
                <PumpMoterLeft pumpnum={parentData} setPumpNum={testfunction} pmsStatsfunction={pmsStatsfunction}/>
                <PumpMoterBottom pumpnum={parentData} pmsStatsfunction={pmsStatsfunction1} />
                <PumpMoterRight pumpnum={parentData} setPumpNum={testfunction} pmsStatsfunction={pmsStatsfunction2}/>
                <PumpMoterMiddle pumpnum={parentData} setPumpNum={testfunction} pmsStats={pmsStatsF}/>
            </PmsWrapper>
        </Wrapper>
